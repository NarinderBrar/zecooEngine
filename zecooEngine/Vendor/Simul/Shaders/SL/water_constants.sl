...
SIMUL_CONSTANT_BUFFER(cbShading,1)
	...
	uniform float		gkfpdngkpfdp;
	uniform float		g_reflectionDistance;
	uniform bool		g_vrEnable;
	uniform float		g_reflectionBrightness;
